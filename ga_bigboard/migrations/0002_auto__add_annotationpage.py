...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnnotationPage'
        db.create_table(u'ga_bigboard_annotationpage', (
        ...
        db.send_create_signal(u'ga_bigboard', ['AnnotationPage'])


    def backwards(self, orm):
        # Deleting model 'AnnotationPage'
        db.delete_table(u'ga_bigboard_annotationpage')
